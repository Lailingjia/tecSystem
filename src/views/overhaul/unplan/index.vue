<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="overhaulInfoList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="申请单位" align="center" prop="companyName" />
      <el-table-column label="申请人" align="center" prop="applicatName" />
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      getList() {
        this.loading = true;
        this.queryParams.inside = this.inside;
